...
from onmt.inputters.graph_dataset import graph_fields
...
def get_fields(
    ...
    assert src_data_type in ['graph', 'text', 'img', 'audio', 'vec'], \
    ...
    if src_data_type == 'graph':
        src_graph_field_kwargs = {"n_feats": 0,
                                  "include_lengths": True,
                                  "pad": pad, "bos": None, "eos": None,
                                  "truncate": src_truncate,
                                  "base_name": "node1"}
